...
interface ImportMetaEnv {
    readonly VUE_APP_PUBLIC_AVAILABILITY: string

    readonly VUE_APP_AWS_SERVER: string
    readonly VUE_APP_PUBLIC_AWS_SERVER: string
    ...
    readonly VUE_APP_PUBLIC_INFR_PROJECT_SERVER: string
    ...
    readonly VUE_APP_PUBLIC_CLIENT_ID: string
    readonly VUE_APP_PUBLIC_PROVIDER: string
    readonly VUE_APP_PUBLIC_REDIRECT_URI: string
    readonly VUE_APP_PUBLIC_AUTHORIZE: string
    readonly VUE_APP_PUBLIC_TOKEN: string
