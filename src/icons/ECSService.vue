  ...
  <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" viewBox="0 0 75 75">
    ...
    <g id="Art" transform="scale(1.5)">
      <path
        ...
        fill="currentColor" />
      <path
        d="M24.39,21.5h-4.5a1,1,0,0,1-1-1V16a1,1,0,0,1,1-1h4.5a1,1,0,0,1,1,1v4.5A1,1,0,0,1,24.39,21.5Zm-3.5-2h2.5V17h-2.5Z"
        fill="currentColor" />
      <path
        d="M24.39,32h-4.5a1,1,0,0,1-1-1V26.5a1,1,0,0,1,1-1h4.5a1,1,0,0,1,1,1V31A1,1,0,0,1,24.39,32Zm-3.5-2h2.5V27.5h-2.5Z"
        fill="currentColor" />
      <path
        d="M24.39,42.51h-4.5a1,1,0,0,1-1-1V37a1,1,0,0,1,1-1h4.5a1,1,0,0,1,1,1v4.51A1,1,0,0,1,24.39,42.51Zm-3.5-2h2.5V38h-2.5Z"
        fill="currentColor" />
      <rect x="26.65" y="17.25" width="13.51" height="2" fill="currentColor" />
      <rect x="26.65" y="27.74" width="13.51" height="2" fill="currentColor" />
      <rect x="26.65" y="38.25" width="13.51" height="2" fill="currentColor" />
      <path d="M16.15,44h-4.5a1,1,0,0,1-1-1V7a1,1,0,0,1,1-1h27a1,1,0,0,1,1,1v4.5h-2V8h-25V42h3.5Z" fill="currentColor" />
